    ...
    <select id="no_sales_order" class="form-control chzn-select">
      ...
      foreach ($q as $k) {
        $q_detail = $db->query("SELECT qty as sisa_total 
                                   ...
                                   WHERE id_sales_order = ?", array($k->id_sales_order));
            ...
            //     );
            // }
          echo "<option value='$k->no_sales_order'>$k->no_sales_order - $k->nama_penerima (QTY : $sisa) </option>";
      }
      ?>
    </select>
  </div>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
                        ...
                        <div class="col-lg-10">
            <select  id="valuta" name="valuta" onchange="cek_valuta(this.value)"  data-placeholder="Pilih Valuta ..." class="form-control chzn-select" tabindex="2" >
               <option value=""></option>
            ...
            <div class="form-group"  id="panel_barang">
                 ...
                 <tbody id="isi_tabel">
                   <tr id="baris_1">
                     ...
                     <td><input type="number" onkeyup="sum_nilai_cek(this.value,'1')"  id="form_qty_1" class="form-control" id="jumlah_1" name="jumlah[]" required="" ><i id="error_stock_1" style="color: red"></i></td>
