              ...
              <section class="content-header">
                  <h1><?=fin_h('finance_balance_sheet', 'Balance Sheet');?></h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Neraca</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Neraca</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_neraca" method="post" class="form-horizontal" action="<?=base_admin();?>modul/neraca/neraca_action.php?act=up">
                            
              <div class="form-group">
                <label for="kategori_akun" class="control-label col-lg-2">kategori_akun </label>
                <div class="col-lg-10">
                  <input type="text" name="kategori_akun" value="<?=$data_edit->kategori_akun;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_rek" value="<?=$data_edit->nama_rek;?>" class="form-control" >
                            ...
                            <input type="hidden" name="id" value="<?=$data_edit->no_rek;?>">
                            <div class="form-group">
