<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>Stock Barang Setengah Jadi Produksi</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Stock Barang Setengah Jadi Produksi</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Stock Barang Setengah Jadi Produksi</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_stock_barang_setengah_jadi_produksi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/stock_barang_setengah_jadi_produksi/stock_barang_setengah_jadi_produksi_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="kd_kategori" value="<?=$data_edit->kd_kategori;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#edit_stock_barang_setengah_jadi_produksi").validate({
