<!-- Content Header (Page header) -->
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li><a href="<?=base_index();?>inbox-incoming">Inbox Incoming</a></li>
                        <li class="active">Detail Inbox Incoming</li>
                    </ol>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title">Detail Inbox Incoming</h3>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" disabled="" value="<?=$data_edit->catatan;?>" class="form-control">
                      ...
                      <a href="<?=base_index();?>inbox-incoming" class="btn btn-success "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
