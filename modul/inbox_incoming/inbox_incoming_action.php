...
JOIN detail_transaksi dt 
    ...
    AND dt.posisi = 'TRANSIT'

-- optional (kalau mau jenis dokpab)
...
if ($cek->status == '1') {
    die(json_encode([
        "status"=>"error",
        "error_message"=>"SPB sudah diterima"
    ]));
}
