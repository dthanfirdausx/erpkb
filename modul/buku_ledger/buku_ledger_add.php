...
<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
              <a href="<?=base_index();?>buku-ledger">Buku Ledger</a>
            </li>
            <li class="active">Add Buku Ledger</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Buku Ledger</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_buku_ledger" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/buku_ledger/buku_ledger_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
             <a href="<?=base_index();?>buku-ledger" class="btn btn-default "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
