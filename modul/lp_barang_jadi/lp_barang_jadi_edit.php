<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>LP Barang Jadi</h1>
                    <ol class="breadcrumb">
                        ...
                        <li>
                        <a href="<?=base_index();?>lp-barang-jadi">LP Barang Jadi</a>
                        </li>
                        <li class="active">Edit LP Barang Jadi</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit LP Barang Jadi</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_lp_barang_jadi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/lp_barang_jadi/lp_barang_jadi_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="no_bpb" value="<?=$data_edit->no_bpb;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="col-lg-3">
                <div class="input-group date" id="tgl1">
                    <input type="text" class="form-control" value="<?=$data_edit->tgl_bpb;?>" name="tgl_bpb" required />
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="project" value="<?=$data_edit->project;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
