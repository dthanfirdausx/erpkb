    ...
    <table class="table table-bordered table-striped">
      <thead>
        <tr>
          ...
          <th style="text-align:right">Qty NG</th>
          <th>Satuan</th>
        </tr>
      </thead>
      <tbody>
      ...
      foreach ($q_fg as $fg){
        ...
        echo "<tr>
          ...
          <td>$fg->kd_barang</td>
          <td>$fg->nm_barang</td>
          <td style='text-align:right'><b>".number_format($fg->jumlah,4)."</b></td>
          <td style='text-align:right'><b>".number_format($fg->qty_ng,4)."</b></td>
          <td>$fg->satuan</td>
        </tr>";
      ...
      if($qb->rowCount() > 0){
        ...
        foreach ($qb as $bb) {
          ...
          echo "<tr>
            ...
            <td>".($bb->no_aju ?: '-')."</td>
            <td>".($bb->no_dokpab ?: '-')."</td>
            <td style='text-align:right'>".number_format($bb->jumlah,4)."</td>
            <td>$bb->satuan</td>
          </tr>";
