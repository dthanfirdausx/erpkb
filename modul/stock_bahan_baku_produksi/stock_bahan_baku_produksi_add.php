...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_stock_bahan_baku_produksi" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/stock_bahan_baku_produksi/stock_bahan_baku_produksi_action.php?act=in">
...
<script type="text/javascript">
    ...
    $("#input_stock_bahan_baku_produksi").validate({
                  ...
                  console.log(responseText);
                      $.each(responseText, function(index) {
                          ...
                          if (responseText[index].status=="die") {
                            ...
                            $('#modal_stock_bahan_baku_produksi').modal('hide');
                            $(".error_data").hide();
