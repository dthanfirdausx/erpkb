<!-- Content Header (Page header) -->
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li><a href="<?=base_index();?>mutasi-barang-modal">Mutasi Barang Modal</a></li>
                        <li class="active">Detail Mutasi Barang Modal</li>
                    </ol>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title">Detail Mutasi Barang Modal</h3>
