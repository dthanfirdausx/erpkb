              ...
              <section class="content-header">
                  <h1>Satuan Packing</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Satuan Packing</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Satuan Packing</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_satuan_packing" method="post" class="form-horizontal" action="<?=base_admin();?>modul/satuan_packing/satuan_packing_action.php?act=up">
                            
              <div class="form-group">
                <label for="satuan packing" class="control-label col-lg-2">satuan packing </label>
                <div class="col-lg-10">
                  <input type="text" name="satuan_packing" value="<?=$data_edit->satuan_packing;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
