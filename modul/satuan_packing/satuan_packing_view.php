 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
        ...
        <?php
            ...
            if (uri_segment(1)==$isi->url) {
              ...
              if ($role_act["up_act"]=="Y") {
                $edit = "<a data-id='+aData[indek]+' href=".base_index()."satuan-packing/edit/'+aData[indek]+' class=\"btn btn-primary btn-sm edit_data \" data-toggle=\"tooltip\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></a>";
              } else {
                  $edit ="";
              }
      ...
      var dtb_satuan_packing = $("#dtb_satuan_packing").DataTable({
           ...
           'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/satuan_packing/satuan_packing_data.php',
  ...
  $('#dtb_satuan_packing').on('draw.dt', function() {
          init_selected()
      });
  ...
  $(document).on('click', '#dtb_satuan_packing tbody tr td', function(event) {
  ...
  function check_selected() {
      var table_select = $('#dtb_satuan_packing tbody tr.selected');
  ...
  function select_deselect(type) {
      if (type == 'select') {
          $('#dtb_satuan_packing tbody tr').addClass('DTTT_selected selected')
      } else {
          $('#dtb_satuan_packing tbody tr').removeClass('DTTT_selected selected')
      }
      init_selected()
  }
...
/* Add a click handler for the delete row */
  $('#bulk_delete').click( function() {
    var anSelected = fnGetSelected( dtb_satuan_packing );
    ...
    $('#ucing').modal({ keyboard: false }).one('click', '#delete', function (e) {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?=base_admin();?>modul/satuan_packing/satuan_packing_action.php?act=del_massal',
