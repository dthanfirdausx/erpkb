...
href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css">
              ...
              <section class="content-header"> 
                  <h1><?=customs_h('legacy_laporan_scrap','Laporan Scrap');?></h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?=customs_h('legacy_edit_laporan_scrap','Edit Laporan Scrap');?></li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title"><?=customs_h('legacy_edit_laporan_scrap','Edit Laporan Scrap');?></h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_laporan_scrap" method="post" class="form-horizontal" action="<?=base_admin();?>modul/laporan_scrap/laporan_scrap_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="no_scrap" value="<?=$data_edit->no_scrap;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="tgl_scrap" value="<?=$data_edit->tgl_scrap;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="radio radio-success ">
                  <input type="radio" name="status"  id="radio1" value="DRAFT" <?=($data_edit->status=="DRAFT")?"checked":"";?> >
                ...
                <div class="radio radio-success ">
                  <input type="radio" name="status"  id="radio2" value="APPROVED" <?=($data_edit->status=="APPROVED")?"checked":"";?> >
                ...
                <div class="radio radio-success ">
                  <input type="radio" name="status"  id="radio3" value="REJECTED" <?=($data_edit->status=="REJECTED")?"checked":"";?> >
...
<input type="text"
       name="no_laporan_produksi[]"
       value="<?=$row->no_laporan_produksi?>"
       class="form-control">
...
<select name="jenis_scrap[]" class="form-control">

<option value="REJECT"
<?=($row->jenis_scrap=="REJECT")?"selected":"";?>>
REJECT
</option>

<option value="SETTING"
<?=($row->jenis_scrap=="SETTING")?"selected":"";?>>
SETTING
</option>

<option value="SISA"
<?=($row->jenis_scrap=="SISA")?"selected":"";?>>
SISA
</option>

<option value="RUSAK"
<?=($row->jenis_scrap=="RUSAK")?"selected":"";?>>
RUSAK
</option>
...
<hr>
                            ...
                            <input type="hidden" name="id" value="<?=$data_edit->id_scrap;?>">
                            <div class="form-group">
...
var no = $("#table_detail_scrap tbody tr").length;
