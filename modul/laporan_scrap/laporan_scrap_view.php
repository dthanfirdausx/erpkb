                            ...
                            <div class="box">
                                ...
                                <?php
                                  foreach ($db->fetch_all("sys_menu") as $isi) {
                                      ...
                                      ?>
                                      <a href="<?=base_index();?>laporan-scrap/tambah" class="btn btn-primary "><i class="fa fa-plus"></i> <?php echo $lang["add_button"];?></a>
                                      <?php
                                          }
                                      }
                                  }
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
        ...
        <?php
            ...
            if (uri_segment(1)==$isi->url) {
              ...
              if ($role_act["up_act"]=="Y") {
                $edit = "<a data-id='+aData[indek]+' href=".base_index()."laporan-scrap/edit/'+aData[indek]+' class=\"btn btn-primary btn-sm edit_data \" data-toggle=\"tooltip\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></a>";
              } else {
                  $edit ="";
              }
      ...
      var dtb_laporan_scrap = $("#dtb_laporan_scrap").DataTable({
           ...
           'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/laporan_scrap/laporan_scrap_data.php',
  ...
  $('#dtb_laporan_scrap').on('draw.dt', function() {
          init_selected()
      });
  ...
  $(document).on('click', '#dtb_laporan_scrap tbody tr td', function(event) {
  ...
  function check_selected() {
      var table_select = $('#dtb_laporan_scrap tbody tr.selected');
  ...
  function select_deselect(type) {
      if (type == 'select') {
          $('#dtb_laporan_scrap tbody tr').addClass('DTTT_selected selected')
      } else {
          $('#dtb_laporan_scrap tbody tr').removeClass('DTTT_selected selected')
      }
      init_selected()
  }
...
/* Add a click handler for the delete row */
  $('#bulk_delete').click( function() {
    var anSelected = fnGetSelected( dtb_laporan_scrap );
    ...
    $('#ucing').modal({ keyboard: false }).one('click', '#delete', function (e) {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?=base_admin();?>modul/laporan_scrap/laporan_scrap_action.php?act=del_massal',
