<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=customs_h('add_wip_position_report','Add Laporan Posisi WIP');?></li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title"><?=customs_h('add_wip_position_report','Add Laporan Posisi WIP');?></h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_laporan_posisi_wip" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/laporan_posisi_wip/laporan_posisi_wip_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
             <a href="<?=base_index();?>laporan-posisi-wip" class="btn btn-default "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
...
<script type="text/javascript">
    ...
    $("#input_laporan_posisi_wip").validate({
