<!-- Content Header (Page header) -->
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
    ...
    '<a href="<?=base_index();?>transfer-produksi/detail/'+aData[indek]+'" class="btn btn-success btn-sm" data-toggle="tooltip" title="Detail"><i class="fa fa-eye"></i></a> ' +

    '<?=$edit;?> ' +

    '<button class="btn btn-warning btn-sm btn_reversal" ' +
    'data-id="'+aData[indek]+'" ' +
    'data-toggle="tooltip" ' +
    'title="Reversal">' +
 ...
 $(document).on('click', '.btn_reversal', function(){

    var id = $(this).data('id');

    Swal.fire({
        title: 'Konfirmasi',
        text: 'Apakah yakin ingin reversal data ini ?',
        icon: 'warning',
        ...
        if(result.isConfirmed){
            ...
            $.ajax({
                url : '<?=base_admin();?>modul/produksi_to_outgoing/produksi_to_outgoing_action.php?act=reversal',
                type : 'POST',
                data : {
                    id : id
                },
                success : function(res){
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil',
                        text: 'Data berhasil direversal',
                        timer: 1500,
                        showConfirmButton: false
                    });

                    dtb_transfer_produksi.draw(false);
