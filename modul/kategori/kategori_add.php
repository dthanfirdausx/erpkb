...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_kategori" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/kategori/kategori_action.php?act=in">
                      
              <div class="form-group">
                <label for="Kode " class="control-label col-lg-2">Kode  </label>
                <div class="col-lg-10">
                  <input type="text" name="kd_kategori" placeholder="Kode " class="form-control" >
                </div>
              </div><!-- /.form-group -->
