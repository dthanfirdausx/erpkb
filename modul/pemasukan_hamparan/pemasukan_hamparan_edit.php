                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_pemasukan_" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pemasukan_hamparan/pemasukan_hamparan_action.php?act=in">
...
<script type="text/javascript">
    function hapus_baris(id) {
      ...
      if (result.isConfirmed) {
        $.ajax({
                   url: "<?= base_url() ?>modul/pemasukan_hamparan/pemasukan_hamparan_action.php?act=hapus_detail",
                   data: {
