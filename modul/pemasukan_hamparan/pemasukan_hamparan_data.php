   ...
   $status_reversal = $value->keterangan; // dari DB
    ...
    if ($status_reversal == 'REVERSED') {
        if (!$sudah_ada_pengganti) {
            $tombol .= '
              <a href="'.base_url().'index.php/pemasukan-hamparan/edit/'.$value->id.'" class="btn btn-success btn-xs" data-toggle="tooltip" title="Buat Ulang">
        ...
        $tombol .= '
          <button type="button" data-id="'.$value->id.'" class="btn btn-warning btn-xs btn-reversal" data-toggle="tooltip" title="Reversal">
