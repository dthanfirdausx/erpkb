                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box-body table-responsive">
                              <form id="upload_tpb_formx" method="post" enctype="multipart/form-data" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/pemasukan_hamparan/pemasukan_hamparan_action.php?act=upload_excel">  
        ...
        <script type="text/javascript">
         ...
         // formData.append('action', 'previewImg');
          ...
          formData.append('fileupload', $('input[type=file]')[0].files[0]); 
            ...
            type: 'POST', 
            dataType: 'json',
            url: '<?=base_admin();?>modul/pemasukan_hamparan/pemasukan_hamparan_action.php?act=upload_excel',
            data :formData,
            type : 'POST', 
            processData: false, 
            contentType: false,
