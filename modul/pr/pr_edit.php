              ...
              <section class="content-header">
                  <h1>Purchase Request</h1>
                    <ol class="breadcrumb">
                        ...
                        <li>
                        <a href="<?=base_index();?>pr">Purchase Request</a>
                        </li>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_pr" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pr/pr_action.php?act=up">
          ...
          <div class="form-group">
                 ...
                 <div class="col-lg-12">
                   ...
                   <tr>
                     ...
                     <th style="width: 40%">Kode Barang</th>
                 ...
                 foreach ($q as $k) {
                  ...
                  <tr id="baris_<?= $no ?>">
                     ...
                     <td><input type="text" id="form_kode_<?= $no ?>" value="<?= $k->kode." , ".$k->nm_barang ?>" placeholder="Kode Barang" onclick="cari_kode('<?= $no ?>')" class="form-control" name="kode[]"  >
