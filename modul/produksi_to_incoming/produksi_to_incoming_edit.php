              ...
              <section class="content-header">
                  <h1>Produksi To Incoming</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Produksi To Incoming</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Produksi To Incoming</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_produksi_to_incoming" method="post" class="form-horizontal" action="<?=base_admin();?>modul/produksi_to_incoming/produksi_to_incoming_action.php?act=up">
...
<script type="text/javascript">
    ...
    $("#edit_produksi_to_incoming").validate({
