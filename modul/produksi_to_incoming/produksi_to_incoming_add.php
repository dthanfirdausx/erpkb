<!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>Produksi To Incoming</h1>
        <ol class="breadcrumb">
            <li>
              <a href="<?=base_index();?>"><i class="fa fa-dashboard"></i> Home</a>
            </li>
            <li>
              <a href="<?=base_index();?>produksi-to-incoming">Produksi To Incoming</a>
            </li>
            <li class="active">Add Produksi To Incoming</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Produksi To Incoming</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_produksi_to_incoming" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/produksi_to_incoming/produksi_to_incoming_action.php?act=in">
          ...
          <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
             <a href="<?=base_index();?>produksi-to-incoming" class="btn btn-default "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
...
<script type="text/javascript">
    ...
    $("#input_produksi_to_incoming").validate({
