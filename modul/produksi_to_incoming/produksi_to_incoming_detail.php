<!-- Content Header (Page header) -->
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li class="active">Detail Produksi To Incoming</li>
                    </ol>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title">Detail Produksi To Incoming</h3>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <textarea class="form-control col-xs-12" rows="5" name="catatan" disabled="" ><?=$data_edit->catatan;?> </textarea>
                      ...
                      <a href="<?=base_index();?>produksi-to-incoming" class="btn btn-success "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
