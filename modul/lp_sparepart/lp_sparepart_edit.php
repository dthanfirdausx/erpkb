<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>LP Sparepart</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit LP Sparepart</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit LP Sparepart</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_lp_sparepart" method="post" class="form-horizontal" action="<?=base_admin();?>modul/lp_sparepart/lp_sparepart_action.php?act=up">
              ...
              <div class="col-lg-3">
                <div class="input-group date" id="tgl1">
                    <input type="text" class="form-control" value="<?=$data_edit->tgl_lap;?>" name="tgl_lap"  />
