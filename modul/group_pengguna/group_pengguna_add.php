 ...
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_group_pengguna" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/group_pengguna/group_pengguna_action.php?act=in">
              ...
              <div class="form-group">
                <label for="Nama Group Pengguna" class="control-label col-lg-3">Nama Group Pengguna <span style="color:#FF0000">*</span></label>
                <div class="col-lg-9">
                  <input type="text" name="level_name" placeholder="Nama Group Pengguna" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              
              <div class="form-group">
                <label for="Deskripsi " class="control-label col-lg-3">Deskripsi  <span style="color:#FF0000">*</span></label>
                <div class="col-lg-9">
