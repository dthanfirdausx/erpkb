          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Nilai Pabean</label>
               ...
               <input type="text" class="form-control" name="cifRupiah" value="<?= $data_header->cifRupiah ?>" id="CIF_RUPIAH" onchange="save_data(this.value,'cifRupiah',$('#ID').val(),'ws_header','id_header')" onkeyup="save_data(this.value,'cifRupiah',$('#ID').val(),'ws_header','id_header')" readonly  >
