          ...
          <?php
            ...
            foreach ($q as $k) {
               echo "<tr>
                       ...
                       <td>
                         <button class='btn btn-primary' onclick='edit_data_barang($k->idBarang,$k->seriBarang)'><i class='fa fa-pencil'></i></button>
...
<script type="text/javascript">
      ...
      // dataTye : 'JSON',
       success : function(data){
        ...
        $("#id_barang").val(data.id);
          $.ajax({
		       url : "<?= base_url() ?>modul/dokumen_pabean/<?= $jenis_dokpab ?>/get_detail_barang.php",
		       type : "POST", 
		       //dataType : "JSON",
		       data : {
		         id : $("#id_barang").val(),
             seriBarang : data.seri,
             ket : 'add',
		       },
		      // dataTye : 'JSON',
		       success : function(data){ 
  ...
  function edit_data_barang(id,seriBarang) {
