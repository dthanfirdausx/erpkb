        ...
        <form role="form">
          <div class="box-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label for="exampleInputEmail1">Harga Penyerahan/Harga Jual/Harga Barang</label>
              
               <input type="text" class="form-control" name="hargaPenyerahan" value="<?= $data_header->hargaPenyerahan ?>" id="CIF_RUPIAH" onchange="save_data(this.value,'hargaPenyerahan',$('#ID').val(),'ws_header','id_header')" onkeyup="save_data(this.value,'hargaPenyerahan',$('#ID').val(),'ws_header','id_header')"  >
      ...
      <div class="box box-primary">
        ...
        <form role="form">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="kantor">Nilai Jasa</label>
            ...
            <div class="form-group"> 
              <label for="kantor">Dasar Pengenaan Pajak</label>
              <input type="text" class="form-control" readonly="" name="dasarPengenaanPajak" id="dasarPengenaanPajak" value="0" >
            </div>
             <div class="form-group"> 
              <label for="kantor">PPN Yang Dipungut(Tarif & Nilai)</label> 
              <div class="row">
                <div class="col-md-4">
                   <input type="text" class="form-control"  name="dasarPengenaanPajak" id="dasarPengenaanPajak" value="0" >
                 </div>
                 <div class="col-md-8">
                   <input type="text" class="form-control" readonly="" name="dasarPengenaanPajak" id="dasarPengenaanPajak" value="0" >
                 </div>
               ...
               <div class="form-group"> 
              <label for="kantor">PPnBM Yang Dipungut(Tarif & Nilai)</label> 
              <div class="row">
                <div class="col-md-4">
                   <input type="text" class="form-control"  name="dasarPengenaanPajak" id="dasarPengenaanPajak" value="0" >
                 </div>
