                            ...
                            <h3 class="box-title">Harga</h3>
                             ...
                             <div class="form-group">
                                <label for="nomor" >Nilai CIF </label>
                                  ...
                                  <input type="text" name="cif" value="<?= $k->cif ?>" id="cif" class="form-control"  onkeyup="save_data(this.value,'cif',$('#id_barang').val(),'ws_barang','idBarang')"> 
                            
                             </div>
                              <div class="form-group">
                                <label for="nomor" >CIF Rupiah </label>
                                
                                  <input type="text" name="cifRupiah"  value="<?= $k->cifRupiah ?>" id="cifRupiah" class="form-control" readonly="" >
                             ...
                             <div class="form-group">
                                <label for="nomor" >Harga Penyerahan </label>
                                
                                  <input type="text" name="hargaPenyerahan" id="hargaPenyerahan" class="form-control" onkeyup="save_data(this.value,'hargaPenyerahan',$('#id_barang').val(),'ws_barang','idBarang')" value="<?= $k->hargaPenyerahan ?>"> 
                              ...
                              <div class="form-group">
                                <label for="nomor" >Harga Perolehan </label>
                                  ...
                                  <input type="text" name="hargaPerolehan" id="hargaPerolehan" class="form-control" onkeyup="save_data(this.value,'hargaPerolehan',$('#id_barang').val(),'ws_barang','idBarang')" value="<?= $k->hargaPerolehan ?>"> 
                             ...
                             <div class="form-group">
                                <label for="nomor" >Nilai Penggantian/Nilai Jasa </label>
                                  ...
                                  <input type="text" name="nilaiJasa" id="nilaiJasa" class="form-control" onkeyup="save_data(this.value,'nilaiJasa',$('#id_barang').val(),'ws_barang','idBarang')" value="<?= $k->nilaiJasa ?>"> 
