<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Log Aktifitas</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Log Aktifitas</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_log_aktifitas" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/log_aktifitas/log_aktifitas_action.php?act=in">
                      
          <div class="form-group">
              <label for="deskripsi" class="control-label col-lg-2">deskripsi </label>
              <div class="col-lg-10">
                <textarea id="editbox" name="deskripsi" class="editbox"></textarea>
              </div>
          </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="tgl" placeholder="tgl" class="form-control" >
                </div>
              </div><!-- /.form-group -->
