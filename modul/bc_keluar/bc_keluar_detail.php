<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1><?=erp_h('master_outbound_customs_type','Outbound Customs Type');?></h1>
                   <ol class="breadcrumb">
                        ...
                        <li class="active"><?=erp_h('common_detail','Detail');?> <?=erp_h('master_outbound_customs_type','Outbound Customs Type');?></li>
                    </ol>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title"><?=erp_h('common_detail','Detail');?> <?=erp_h('master_outbound_customs_type','Outbound Customs Type');?></h3>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" disabled="" value="<?=$data_edit->nama;?>" class="form-control">
                      ...
                      <a href="<?=base_index();?>bc-keluar" class="btn btn-success "><i class="fa fa-step-backward"></i> <?=erp_h('common_back','Back');?></a>
