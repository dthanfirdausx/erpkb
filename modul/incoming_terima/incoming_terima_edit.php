<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>Incoming Terima</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Incoming Terima</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Incoming Terima</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_incoming_terima" method="post" class="form-horizontal" action="<?=base_admin();?>modul/incoming_terima/incoming_terima_action.php?act=up">
              ...
              <div class="col-lg-3">
                <div class="input-group date" id="tgl1">
                    <input type="text" class="form-control" value="<?=$data_edit->tgl_lpb;?>" name="tgl_lpb"  />
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="catatan" value="<?=$data_edit->catatan;?>" class="form-control" >
                            ...
                            <input type="hidden" name="id" value="<?=$data_edit->no_lpb;?>">
                            <div class="form-group">
