<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>LPB Produksi</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit LPB Produksi</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit LPB Produksi</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_lpb_produksi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/lpb_produksi/lpb_produksi_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="dept" value="<?=$data_edit->dept;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="user_trt" value="<?=$data_edit->user_trt;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="userid" value="<?=$data_edit->userid;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
