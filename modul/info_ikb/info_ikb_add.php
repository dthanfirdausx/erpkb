<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Info IKB</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Info IKB</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_info_ikb" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/info_ikb/info_ikb_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="prop" placeholder="prop" class="form-control" >
                </div>
              </div><!-- /.form-group -->
