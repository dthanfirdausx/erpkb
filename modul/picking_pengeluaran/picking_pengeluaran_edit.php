                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_pengeluaran_hamparan" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pengeluaran_hamparan/pengeluaran_hamparan_action.php?act=in">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <select name="kd_catdet" id="detail_catatan_kd_catdet" data-placeholder="Pilih kd_catdet ..." class="form-control chzn-select" tabindex="2" required>
                   ...
                   foreach ($db->query("select * from detail_catatan where jenis_dokpab='$data_edit->jenis_dokpab'") as $isi) {
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 $q = $db->query("select d.*,ba.nm_barang ,ba.satuan as unit
                              from tmp_pengeluaran_detail2 d 
                 ...
                 foreach ($q as $k) {
                  ...
                  <tr id="baris_<?= $no ?>">
                     ...
                     <td><input type="text" id="form_unit_<?= $no ?>" value="<?= $k->unit ?>"  class="form-control" name="unit[]" style="width: 70px" readonly=""></td> 
