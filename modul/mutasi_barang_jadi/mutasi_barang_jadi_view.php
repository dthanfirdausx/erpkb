<!-- Content Header (Page header) -->
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
          ...
          <i class="icon fa fa-warning"></i> <span class="isi_warning_delete"></span>
                        ...
                        <table id="dtb_mutasi_barang_jadi" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                  <th>No</th>
                                  <th>Kode</th>
        ...
        <?php
            ...
            if ($role_act['del_act']=='Y') {
                $del = "<button data-id='+aData[indek]+' data-uri=".base_admin()."modul/mutasi_barang_jadi/mutasi_barang_jadi_action.php".' class="btn btn-danger hapus_dtb_notif btn-sm" data-toggle="tooltip" title="Hapus" data-variable="dtb_mutasi_barang_jadi"><i class="fa fa-trash"></i></button>';
            } else {
                $del="";
            }
                             }
        ...
        url :'<?=base_admin();?>modul/mutasi_barang_jadi/mutasi_barang_jadi_action.php?act=buat_view',
      ...
      var dtb_mutasi_barang_jadi = $("#dtb_mutasi_barang_jadi").DataTable({
           ...
           'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/mutasi_barang_jadi/mutasi_barang_jadi_data.php',
                data:   function ( d ) {
  ...
  $('#dtb_mutasi_barang_jadi').on('draw.dt', function() {
          init_selected()
      });
  ...
  // $(document).on('click', '#dtb_mutasi_barang_jadi tbody tr td', function(event) {
  ...
  function filter() {
      ...
      $("#dtb_mutasi_barang_jadi").dataTable().fnDraw(); 
  }

  function info_detail(kd_barang,ket) {
     // alert(kd_barang);
     if (ket=='1') {
      var tabel = 'vmutasipemasukanbjdetails';
     ...
     $.ajax({
        ...
        url :'<?=base_admin();?>modul/mutasi_barang_jadi/mutasi_barang_jadi_action.php?act=show_detail_pemasukan',
        success : function(data){
  ...
  function check_selected() {
      var table_select = $('#dtb_mutasi_barang_jadi tbody tr.selected');
  ...
  function select_deselect(type) {
      if (type == 'select') {
          $('#dtb_mutasi_barang_jadi tbody tr').addClass('DTTT_selected selected')
      } else {
          $('#dtb_mutasi_barang_jadi tbody tr').removeClass('DTTT_selected selected')
      }
      init_selected()
  }
...
/* Add a click handler for the delete row */
  $('#bulk_delete').click( function() {
    var anSelected = fnGetSelected( dtb_mutasi_barang_jadi );
    ...
    $('#ucing').modal({ keyboard: false }).one('click', '#delete', function (e) {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?=base_admin();?>modul/mutasi_barang_jadi/mutasi_barang_jadi_action.php?act=del_massal',
