      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_mutasi_bahan_baku" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/mutasi_bahan_baku/mutasi_bahan_baku_action.php?act=in">
...
<script type="text/javascript">
    ...
    $("#input_mutasi_bahan_baku").validate({
