              ...
              <section class="content-header">
                  <h1><?=customs_h('mutation_raw_material','Mutasi Bahan Baku');?></h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?=customs_h('edit_raw_material_mutation','Edit Mutasi Bahan Baku');?></li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title"><?=customs_h('edit_raw_material_mutation','Edit Mutasi Bahan Baku');?></h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_mutasi_bahan_baku" method="post" class="form-horizontal" action="<?=base_admin();?>modul/mutasi_bahan_baku/mutasi_bahan_baku_action.php?act=up">
                ...
                <div class="col-lg-10">
                  <input type="text" name="type" value="<?=$data_edit->type;?>" class="form-control" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                <a href="<?=base_index();?>mutasi-bahan-baku" class="btn btn-default "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
...
<script type="text/javascript">
    ...
    $("#edit_mutasi_bahan_baku").validate({
