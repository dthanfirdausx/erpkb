 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
    ...
    <div class="modal fade" id="modal_import_barang" tabindex="-1" role="dialog" aria-labelledby="modalImportBarangLabel">
      ...
      $("#add_barang").click(function() {
          $.ajax({
              url : "<?=base_admin();?>modul/barang/barang_add.php",
              type : "GET",
    ...
    $(".table").on('click','.edit_data',function(event) {
        ...
        $.ajax({
            url : "<?=base_admin();?>modul/barang/barang_edit.php",
            type : "post",
            data : {id_data:id},
            success: function(data) {
                $("#isi_barang").html(data);
    ...
    $('#modal_barang').modal({ keyboard: false,backdrop:'static' });
      ...
      var dtb_barang = $("#dtb_barang").DataTable({
           ...
           'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/barang/barang_data.php',
  ...
  $('#dtb_barang').on('draw.dt', function() {
          init_selected()
      });
  ...
  $(document).on('click', '#dtb_barang tbody tr td', function(event) {
  ...
  function check_selected() {
      var table_select = $('#dtb_barang tbody tr.selected');
  ...
  function select_deselect(type) {
      if (type == 'select') {
          $('#dtb_barang tbody tr').addClass('DTTT_selected selected')
      } else {
          $('#dtb_barang tbody tr').removeClass('DTTT_selected selected')
      }
      init_selected()
  }
...
/* Add a click handler for the delete row */
  $('#bulk_delete').click( function() {
    var anSelected = fnGetSelected( dtb_barang );
    ...
    $('#ucing').modal({ keyboard: false }).one('click', '#delete', function (e) {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?=base_admin();?>modul/barang/barang_action.php?act=del_massal',
