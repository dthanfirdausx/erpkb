UPDATE sys_menu
SET nav_act='customs_stock_traceability',
    page_name='Customs Stock Traceability',
    ...
    tampil='Y',
    type_menu='page'
WHERE url='customs-stock-traceability' OR page_name='Customs Stock Traceability';

INSERT INTO sys_menu (nav_act,page_name,url,main_table,icon,urutan_menu,parent,parent_name,dt_table,tampil,type_menu)
SELECT 'customs_stock_traceability','Customs Stock Traceability','customs-stock-traceability','stock_layer','fa-file-text',5,572,'Inventory Management','Y','Y','page'
FROM DUAL
...
WHERE m.url='customs-stock-traceability' AND r.id IS NULL;
