UPDATE sys_menu
SET nav_act='stock_aging',
    page_name='Stock Aging',
    url='stock-aging',
    ...
    tampil='Y',
    type_menu='page'
WHERE url='stock-aging' OR page_name='Stock Aging';

INSERT INTO sys_menu (nav_act,page_name,url,main_table,icon,urutan_menu,parent,parent_name,dt_table,tampil,type_menu)
SELECT 'stock_aging','Stock Aging','stock-aging','stock_layer','fa-clock-o',3,572,'Inventory Management','Y','Y','page'
FROM DUAL
...
WHERE m.url='stock-aging' AND r.id IS NULL;
