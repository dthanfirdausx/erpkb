...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_data_barang" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/data_barang/data_barang_action.php?act=in">
                      
              <div class="form-group">
                <label for="Kode Barang" class="control-label col-lg-2">Kode Barang </label>
                <div class="col-lg-10">
                  <input type="text" name="kd_barang" placeholder="Kode Barang" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nm_barang" placeholder="Nama Barang" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="spec" placeholder="Spec" class="form-control" >
                </div>
              </div><!-- /.form-group -->
