<!-- Content Header (Page header) -->
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
          ...
          <i class="icon fa fa-warning"></i> <span class="isi_warning_delete"></span>
                        ...
                        <table id="dtb_user_group" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                  <th>No</th>
                                  <th>level</th>
        ...
        <?php
            ...
            if ($role_act['del_act']=='Y') {
                $del = "<button data-id='+aData[indek]+' data-uri=".base_admin()."modul/user_group/user_group_action.php".' class="btn btn-danger hapus_dtb_notif btn-sm" data-toggle="tooltip" title="Hapus" data-variable="dtb_user_group"><i class="fa fa-trash"></i></button>';
            } else {
                $del="";
            }
                             }
    ...
    $('#modal_user_group').modal({ keyboard: false,backdrop:'static' });
      ...
      var dtb_user_group = $("#dtb_user_group").DataTable({
           "fnCreatedRow": function( nRow, aData, iDataIndex ) {
            ...
            $('td:eq('+indek+')', nRow).html('<a href="<?=base_index();?>user-group/detail/'+aData[indek]+'"  class="btn btn-success btn-sm" data-toggle="tooltip" title="Detail"><i class="fa fa-eye"></i></a> <?=$edit;?> <?=$del;?>');
           ...
           'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/user_group/user_group_data.php',
  ...
  $('#dtb_user_group').on('draw.dt', function() {
          init_selected()
      });
  ...
  $(document).on('click', '#dtb_user_group tbody tr td', function(event) {
  ...
  function check_selected() {
      var table_select = $('#dtb_user_group tbody tr.selected');
  ...
  function select_deselect(type) {
      if (type == 'select') {
          $('#dtb_user_group tbody tr').addClass('DTTT_selected selected')
      } else {
          $('#dtb_user_group tbody tr').removeClass('DTTT_selected selected')
      }
      init_selected()
  }
...
/* Add a click handler for the delete row */
  $('#bulk_delete').click( function() {
    var anSelected = fnGetSelected( dtb_user_group );
    ...
    $('#ucing').modal({ keyboard: false }).one('click', '#delete', function (e) {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?=base_admin();?>modul/user_group/user_group_action.php?act=del_massal',
