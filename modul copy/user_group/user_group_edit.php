   ...
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_user_group" method="post" class="form-horizontal" action="<?=base_admin();?>modul/user_group/user_group_action.php?act=up">
              ...
              <div class="form-group">
                <label for="level name" class="control-label col-lg-2">level name </label>
                <div class="col-lg-10">
                  <input type="text" name="level_name" value="<?=$data_edit->level_name;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="deskripsi" value="<?=$data_edit->deskripsi;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
