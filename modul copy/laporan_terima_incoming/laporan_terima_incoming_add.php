<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Laporan Terima Incoming</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Laporan Terima Incoming</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_laporan_terima_incoming" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/laporan_terima_incoming/laporan_terima_incoming_action.php?act=in">
...
<script type="text/javascript">
    ...
    $("#input_laporan_terima_incoming").validate({
