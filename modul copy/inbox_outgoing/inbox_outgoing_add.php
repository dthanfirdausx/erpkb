...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_inbox_outgoing" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/inbox_outgoing/inbox_outgoing_action.php?act=in">
