...
$columns = array(
    'v_inbox_outgoing.nm_dari',
    'v_inbox_outgoing.no_transfer',
    'v_inbox_outgoing.tgl_transfer',
    'v_inbox_outgoing.dept',
    'v_inbox_outgoing.user',
    'v_inbox_outgoing.ket',
  ...
  //set order by column
  $datatable->set_order_by("v_inbox_outgoing.tgl_transfer");
  ...
  dept,user as name_ppc,ket as catatan from  v_inbox_outgoing   ",$columns);
