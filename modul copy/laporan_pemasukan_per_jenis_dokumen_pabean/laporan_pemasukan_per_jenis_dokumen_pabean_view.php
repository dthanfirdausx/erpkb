<!-- Content Header (Page header) -->
               <!--  <section class="content-header">
                    <h1>
                        Laporan Pemasukan Per Jenis Dokumen Pabean
                    </h1>
                        <ol class="breadcrumb">
                        ...
                        <li class="active">Laporan Pemasukan Per Jenis Dokumen Pabean List</li>
                    </ol>
                </section> -->
                            ...
                            <div class="box">
                             ...
                             <form id="input_pemasukan_hamparan" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/pemasukan_hamparan/pemasukan_hamparan_action.php?act=in">                   
                                ...
                                <div class="form-group">
                                    <label for="Tanggal BPB" class="control-label col-lg-2">Tanggal S/D </label>
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
        ...
        <h3 style="text-align: center">Laporan Pemasukan Barang Per Dokumen Pabean</h3>
  ...
  function download_data(){
    ...
    if (tgl_awal=='' && tgl_akhir=='' ) {
      ...
      alert("Pilih Tanggal Akhir ");
       ...
       document.location="<?= base_url() ?>modul/laporan_pemasukan_per_jenis_dokumen_pabean/down.php?tgl_awal="+tgl_awal+"&tgl_akhir="+tgl_akhir+"&jenis_dokpab="+jenisbc;
    }
