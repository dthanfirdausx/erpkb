...
switch ($_GET["act"]) {
  ...
  case "buat_view":
   ...
   $db->query("drop view v_hitung_mutasi_bahan_baku");   
   $db->query("drop view v_mutasi_bahan_baku"); 
   $db->query("create view v_hitung_mutasi_bahan_baku as select b.id, ifnull(c.jml,0) as closing,b.satuan, b.kd_barang,b.nm_barang,ifnull(p1.jml,0) as p1,ifnull(p2.jml,0) as p2,ifnull(p3.jml,0) as p3,ifnull(p4.jml,0) as p4,ifnull(k.jml,0) as k1,
...
"); 
   ...
   $db->query(" create view v_mutasi_bahan_baku as
    select  id, `v_hitung_mutasi_bahan_baku`.`kd_barang` AS `kd_barang`,`v_hitung_mutasi_bahan_baku`.`nm_barang` AS `nm_barang`,`v_hitung_mutasi_bahan_baku`.`satuan` AS `satuan`,closing, `v_hitung_mutasi_bahan_baku`.`p1` + `v_hitung_mutasi_bahan_baku`.`p3` - (`v_hitung_mutasi_bahan_baku`.`k2` + `v_hitung_mutasi_bahan_baku`.`k1`) AS `saldo_awal`,`v_hitung_mutasi_bahan_baku`.`p2` + `v_hitung_mutasi_bahan_baku`.`p4` AS `pemasukan`,`v_hitung_mutasi_bahan_baku`.`k3` + `v_hitung_mutasi_bahan_baku`.`k4` AS `pengeluaran`,`v_hitung_mutasi_bahan_baku`.`p1` + `v_hitung_mutasi_bahan_baku`.`p3` - (`v_hitung_mutasi_bahan_baku`.`k2` + `v_hitung_mutasi_bahan_baku`.`k1`) + (`v_hitung_mutasi_bahan_baku`.`p2` + `v_hitung_mutasi_bahan_baku`.`p4`) - (`v_hitung_mutasi_bahan_baku`.`k3` + `v_hitung_mutasi_bahan_baku`.`k4`) AS `saldo_akhir`,'0' AS `penyesuaian`,'0' AS `stock_opname`,'0' AS `selisih`,'' AS `ket`,'".$_SESSION['username']."' as userid from `v_hitung_mutasi_bahan_baku`");   
