              ...
              <section class="content-header">
                  <h1>Incoming Outgoing</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Incoming Outgoing</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Incoming Outgoing</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_incoming_outgoing" method="post" class="form-horizontal" action="<?=base_admin();?>modul/incoming_outgoing/incoming_outgoing_action.php?act=up">
...
<script type="text/javascript">
    ...
    $("#edit_incoming_outgoing").validate({
