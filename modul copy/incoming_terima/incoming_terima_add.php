<!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>Incoming Terima</h1>
        <ol class="breadcrumb">
            <li>
              <a href="<?=base_index();?>"><i class="fa fa-dashboard"></i> Home</a>
            </li>
            <li>
              <a href="<?=base_index();?>incoming-terima">Incoming Terima</a>
            </li>
            <li class="active">Add Incoming Terima</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Incoming Terima</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_incoming_terima" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/incoming_terima/incoming_terima_action.php?act=in">
              ...
              <div class="form-group">
                <label for="No LPB" class="control-label col-lg-2">No LPB </label>
                <div class="col-lg-10">
                  <input type="text" name="no_lpb" placeholder="No LPB" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              
          <div class="form-group">
              <label for="Tanggal LPB" class="control-label col-lg-2">Tanggal LPB </label>
              <div class="col-lg-3">
                <div class="input-group date" id="tgl1">
                    <input type="text" class="form-control" name="tgl_lpb"  />
          ...
          <div class="form-group">
              ...
              <div class="col-lg-3">
                <div class="input-group date" id="tgl2">
                    <input type="text" class="form-control" name="tgl_spb"  />
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
          ...
          <div class="form-group">
                        <label for="Departemen" class="control-label col-lg-2">Departemen </label>
                        <div class="col-lg-10">
            <select  id="dept" name="dept" data-placeholder="Pilih Departemen ..." class="form-control chzn-select" tabindex="2" >
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
             <a href="<?=base_index();?>incoming-terima" class="btn btn-default "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
...
<script type="text/javascript">
    ...
    $("#input_incoming_terima").validate({
