...
$data_edit = $db->fetch_single_row("catatan","kd_catatan",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_catatan_kirim" method="post" class="form-horizontal" action="<?=base_admin();?>modul/catatan_kirim/catatan_kirim_action.php?act=up">
              ...
              <input type="hidden" name="id" value="<?=$data_edit->kd_catatan;?>">
