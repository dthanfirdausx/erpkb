...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_management_shift" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/management_shift/management_shift_action.php?act=in">
                      
              <div class="form-group">
                <label for="Nama Shift" class="control-label col-lg-2">Nama Shift </label>
                <div class="col-lg-10">
                  <input type="text" name="namaShift" placeholder="Nama Shift" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#input_management_shift").validate({
