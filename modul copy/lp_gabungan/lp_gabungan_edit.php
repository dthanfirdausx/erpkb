              ...
              <section class="content-header">
                  <h1>LP Gabungan</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit LP Gabungan</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit LP Gabungan</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_lp_gabungan" method="post" class="form-horizontal" action="<?=base_admin();?>modul/lp_gabungan/lp_gabungan_action.php?act=up">
