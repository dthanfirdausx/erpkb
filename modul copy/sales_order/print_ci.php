...
<table>
  ...
  <tr>
    ...
    <td><?= $kd->qty ?></td>
    <td><?= $kd->satuan ?></td>
    <td><label style="float: left;"><?= $k->currency ?></label><label style="float: right;"><?= number_format($kd->price) ?></label></td>
    <td><label style="float: left;"><?= $k->currency ?></label><label style="float: right;"><?= number_format($kd->price * $kd->qty) ?></label></td>
  </tr>
  <?php
...
if ($k->tax=='include') {
 ...
 <tr>
    ...
    <td></td>
    <td></td>
    <td><label style="float: left;"><?= $k->currency ?></label><label style="float: right;"><?= number_format($total*0.11) ?></label></td>
  </tr>
 <?php
 $total  = $total + ($total*0.11);
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td><label style="float: left;"><?= $k->currency ?></label><label style="float: right;"><?= number_format($total) ?></label></td>
  </tr>
</table>
