<!-- Content Header (Page header) -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="tgl_jurnal" value="<?=$data_edit->tgl_jurnal;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="debet_usd" value="<?=$data_edit->debet_usd;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="kredit_usd" value="<?=$data_edit->kredit_usd;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="tgl_insert" value="<?=$data_edit->tgl_insert;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="valuta" value="<?=$data_edit->valuta;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
