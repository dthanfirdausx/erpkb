<!-- Content Header (Page header) -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box-body table-responsive">
                              ...
                              <iframe src="<?= base_url_akunting ?>akuntansi/index.php/jurnal_umum" style="width: 100%;bottom: 0px solid transparent;" frameborder="0"></iframe>
                              </div>
                    </div><!-- /.box-body -->
                  </div><!-- /.box -->
                </div>
        ...
        <?php
            ...
            if (uri_segment(1)==$isi->url) {
              ...
              if ($role_act["up_act"]=="Y") {
                $edit = "<a data-id='+aData[indek]+' href=".base_index()."jurnal-umum/edit/'+aData[indek]+' class=\"btn btn-primary btn-sm edit_data \" data-toggle=\"tooltip\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></a>";
              } else {
                  $edit ="";
              }
      ...
      var dtb_jurnal_umum = $("#dtb_jurnal_umum").DataTable({
           "fnCreatedRow": function( nRow, aData, iDataIndex ) {
            ...
            $('td:eq('+indek+')', nRow).html('<a href="<?=base_index();?>jurnal-umum/detail/'+aData[indek]+'"  class="btn btn-success btn-sm" data-toggle="tooltip" title="Detail"><i class="fa fa-eye"></i></a> <?=$edit;?> <?=$del;?>');
