...
$columns = array(
    'v_inbox_produksi.nm_dari',
    'v_inbox_produksi.no_transfer',
    'v_inbox_produksi.tgl_transfer',
    'v_inbox_produksi.dept',
    'v_inbox_produksi.user',
    'v_inbox_produksi.ket',
  ...
  //set order by column
  $datatable->set_order_by("v_inbox_produksi.tgl_transfer");
  ...
  dept,user as name_ppc,ket as catatan from  v_inbox_produksi   ",$columns);
