<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Inbox Incoming</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Inbox Incoming</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_inbox_incoming" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/inbox_incoming/inbox_incoming_action.php?act=in">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-3">
                <div class="input-group date" id="tgl1">
                    <input type="text" class="form-control" name="tgl_spb" required />
          ...
          <div class="form-group">
            ...
            <select  id="dept" name="dept" data-placeholder="Pilih Departemen ..." class="form-control chzn-select" tabindex="2" required>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="name_ppc" placeholder="Nama PPC" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
