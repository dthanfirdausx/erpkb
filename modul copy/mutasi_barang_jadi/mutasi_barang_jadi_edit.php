                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_mutasi_barang_jadi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/mutasi_barang_jadi/mutasi_barang_jadi_action.php?act=up">
...
<script type="text/javascript">
    ...
    $("#edit_mutasi_barang_jadi").validate({
