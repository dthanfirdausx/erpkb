    ...
    <table class="table">
      ...
      <tbody id="isi_tabel">
        <tr id="baris_1">
          ...
          <td>
            <input type="text" id="form_stock_1" class="form-control" readonly>
          </td>

          <td>
            <input type="number" id="form_qty_1" name="qty[]" class="form-control">
          </td>
...
<table class="table">
  ...
  <tbody id="isi_hasil">
    <tr id="hasil_1">
      ...
      <td>
        <input type="number" name="qty_jadi[]" id="qty_jadi_1" class="form-control">
      </td>

      <td>
        <input type="text" name="unit_jadi[]" id="unit_jadi_1" class="form-control">
      </td>
    </tr>
  </tbody>
</table>
...
<script type="text/javascript">
  ...
  function add_hasil(){
    ...
    <tr id="hasil_${id}">
        ...
        <td>
            <input type="number" name="qty_jadi[]" class="form-control">
        </td>

        <td>
            <input type="text" name="unit_jadi[]" id="unit_jadi_${id}" class="form-control">
        </td>
    </tr>
    `;
  ...
  function hapus_baris(id){
   ...
   function add_baris() {
    ...
    <tr id="baris_${id_baris}">
        ...
        <td>
            <input type="text" id="form_stock_${id_baris}" class="form-control" readonly>
        </td>

        <td>
            <input type="number" id="form_qty_${id_baris}" name="qty[]" class="form-control">
        </td>
                        ...
                        select: function (event, ui) {
                             ...
                             $("#id_input_"+id).val(ui.item.id_barang);
                              ...
                              $.ajax({
                                ...
                                dataType : 'JSON',
                                success: function (data) {
                                  var data_stok = '<input type="text" id="form_stock_'+id+'" class="form-control" name="stock[]" readonly="" style="display:none" >';
                                  // var data_stok = ''; 
                                  if (parseInt(data.stock)>0) {
                                      $("#stok_tersedia_"+id).html("Stok : "+data.stock+data_stok);
                                  }else{
                                   var data_stok = '<input type="text" id="form_stock_'+id+'" class="form-control" name="stock[]" readonly="" style="display:none" >';
                                   // var data_stok = ''; 
                                    $("#detail_modal").html(data.detail_bahan_baku);
                                    $("#stok_tersedia_"+id).html("<i class='label label-danger'>Ada bahan baku yang kosong</i> <br> <i><a onclick='detail_bahan_baku()' style='cursor:pointer'> <i class='fa fa-eye'> </i> Detail </a> "+data_stok);
