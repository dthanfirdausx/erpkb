...
$data_edit = $db->fetch_single_row("vtotalstockprodbb","",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_stock_bahan_baku_produksi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/stock_bahan_baku_produksi/stock_bahan_baku_produksi_action.php?act=up">
...
<script type="text/javascript">
    ...
    $("#edit_stock_bahan_baku_produksi").validate({
