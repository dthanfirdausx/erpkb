...
$data_edit = $db->fetch_single_row("h_hari","hari_id",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_referensi_hari" method="post" class="form-horizontal" action="<?=base_admin();?>modul/referensi_hari/referensi_hari_action.php?act=up">
                  ...
                  console.log(responseText);
                      $.each(responseText, function(index) {
                          ...
                          if (responseText[index].status=="die") {
                            ...
                            $('#modal_referensi_hari').modal('hide');
                            $(".error_data").hide();
