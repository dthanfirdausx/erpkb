...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_referensi_hari" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/referensi_hari/referensi_hari_action.php?act=in">
