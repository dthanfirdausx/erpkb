              ...
              <section class="content-header">
                  <h1>Stock Barang Jadi Produksi</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Stock Barang Jadi Produksi</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Stock Barang Jadi Produksi</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_stock_barang_jadi_produksi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/stock_barang_jadi_produksi/stock_barang_jadi_produksi_action.php?act=up">
...
<script type="text/javascript">
    ...
    $("#edit_stock_barang_jadi_produksi").validate({
